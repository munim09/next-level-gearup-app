    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md bg-white rounded-xl shadow-sm border p-8">
          ...
          <p className="text-gray-500 text-sm text-center mt-1">Join GearUp to start renting gear</p>
          ...
          <form action={formAction} className="mt-6 space-y-5" noValidate>
            ...
            <div>
              <span className="block text-sm font-medium mb-2">I want to join as</span>
              <div className="flex gap-3">
                <label className="flex-1 border rounded-lg p-3 text-center cursor-pointer has-[:checked]:bg-indigo-50 has-[:checked]:border-indigo-500">
                  ...
                  <span className="block font-medium text-sm">Customer</span>
                  <span className="text-xs text-gray-500">Rent gear</span>
                </label>
                <label className="flex-1 border rounded-lg p-3 text-center cursor-pointer has-[:checked]:bg-indigo-50 has-[:checked]:border-indigo-500">
                  <input type="radio" name="role" value="PROVIDER" className="hidden" />
                  <span className="block font-medium text-sm">Provider</span>
                  <span className="text-xs text-gray-500">List gear</span>
                </label>
              </div>
              {state.errors?.role && (
                <p className="text-xs text-red-500 mt-1">{state.errors.role[0]}</p>
              )}
            </div>
