    ...
    <nav className="bg-white shadow-sm border-b sticky top-0 z-40">
      ...
      {open && (
        <div className="md:hidden bg-white border-t px-4 py-4 space-y-3 text-sm font-medium">
          <Link href="/gear" className="block px-3 py-2 rounded-lg hover:bg-gray-100">
            Browse Gear
          </Link>
          <Link href="/providers" className="block px-3 py-2 rounded-lg hover:bg-gray-100">
            Providers
          </Link>
          {user ? (
            <ProfileDropdown user={user} />
            ...
            <>
              <Link href="/auth/login" className="block px-3 py-2 rounded-lg hover:bg-gray-100">
                Login
              </Link>
              <Link href="/auth/register" className="block px-3 py-2 rounded-lg bg-indigo-600 text-white text-center">
                Sign Up
              </Link>
            </>
          )}
